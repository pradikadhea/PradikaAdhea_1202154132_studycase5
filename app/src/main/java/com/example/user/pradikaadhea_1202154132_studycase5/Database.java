...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String nama_database = "todo.db";
    ...
    public Database(Context context) {
        ...
        db.execSQL("create table if not exists "+nama_tabel+" (todo varchar(35) primary key, " +
                "description varchar(50), priority varchar(3))");
    }

    //ketika database dibuat
    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table if not exists "+nama_tabel+" (todo varchar(35) " +
                "primary key, description varchar(50), priority varchar(3))");
    }
    ...
    public void readdata(ArrayList<Data> daftar){
        Cursor cursor = this.getReadableDatabase().rawQuery("select todo, description, priority " +
                "from "+nama_tabel, null);
